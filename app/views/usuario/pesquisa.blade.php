  ...
  <div class="modal-dialog devoops-modal" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="titulo_modal">{{trans('geral.titulo_modal')}}</h4>
      </div>
      <div class="modal-body">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="text" class="form-control required" name="nome" placeholder="{{trans('geral.nome')}}" title="Nome">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label">*{{trans('geral.login')}}</label>
			<div class="col-sm-4">
				<input type="text" class="form-control required" name="login" placeholder="{{trans('geral.login')}}" title="Login">
			</div>
		</div>
		<div class="form-group">
